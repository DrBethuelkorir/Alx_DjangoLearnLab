...
from .views import listallbook, LibraryDetailsView, Register  # Import Register class
...
urlpatterns = [
    ...
    path('register/', Register.as_view(), name='register'),  # Class-based view with .as_view()
]